...
export default async function Home() {
  ...
  return (
    <main className="max-w-lg m-auto mt-8 p-4 flex flex-col gap-8 items-center">
      ...
      <span className="text-xs">Desafío por <a href="https://www.youtube.com/@goncypozzo" target="_blank" rel="noopener noreferrer" className="text-blue-400 underline ">Goncy</a>. Codeado por Esteban Montecinos</span>
    </main>
  );
}
